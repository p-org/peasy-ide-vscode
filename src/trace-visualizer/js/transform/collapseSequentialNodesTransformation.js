...
CollapseSequentialNodesTransformation.prototype = Object.create(
  Transformation.prototype
);
CollapseSequentialNodesTransformation.prototype.constructor =
...
CollapseSequentialNodesTransformation.prototype.setThreshold = function (
  ...
  if (threshold < 2) {
    throw new Exception(
      "CollapseSequentialNodesTransformation.prototype.setThreshold: Invalid threshold. Threshold must be greater than or equal to 2"
    );
  }
 ...
 */
CollapseSequentialNodesTransformation.prototype.removeExemption = function (
  node
) {
  if (node.hasFamily()) {
    var logEvents = node.getLogEvents();
 ...
 */
CollapseSequentialNodesTransformation.prototype.toggleExemption = function (
  node
) {
 ...
 */
CollapseSequentialNodesTransformation.isCollapseable = function (
  node,
  threshold
) {
  if (threshold < 2) {
    throw new Exception(
      "CollapseSequentialNodesTransformation.isCollapseable: Invalid threshold. Threshold must be greater than or equal to 2"
    );
  }
