...
function Transformer() {
  ...
  /** @private */
  this.collapseSequentialNodesTransformation =
    new CollapseSequentialNodesTransformation(2);
...
Transformer.prototype.toggleCollapseNode = function (node) {
  console.log("toggling collapse node");
...
Transformer.prototype.showDiff = function (view) {
  ...
  var trans = new ShowDiffTransformation(
    view,
    this.uniqueHosts,
    this.hiddenHosts,
    this.uniqueEvents,
