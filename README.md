...
| `F6`     | Show P error tracing visualizations to help debug P code.                                                                                                              |
| `F7`     | Generate State machine Visualization code for better sharing of designs with teams through this open source state machine [visualization tool](https://stately.ai/viz) |
...
2. Building custom motifs  
   You can build your own custom motif pattern in the search bar under the "Structured Search" tab. In the example, the custom motif searches for pattern where machine 1 sends something to machine 2, and then later sends something to machie 3, and lastly sends something to machine 4. 1. Slingle click creates a node in a machine  
